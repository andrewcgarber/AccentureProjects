...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="com.soapexpl.calculator.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        com.soapexpl.calculator.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
...
case 13:
        ...
        int func13mtemp = sampleCalculatorProxyid.func(a_1idTemp,b_2idTemp);

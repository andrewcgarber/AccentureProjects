...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.soapexpl.calculator.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SOAPExample/services/Calculator";
    ...
    public com.soapexpl.calculator.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soapexpl.calculator.CalculatorSoapBindingStub _stub = new com.soapexpl.calculator.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soapexpl.calculator.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soapexpl.calculator.CalculatorSoapBindingStub _stub = new com.soapexpl.calculator.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calculator.soapexpl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calculator.soapexpl.com", "Calculator"));
        }
